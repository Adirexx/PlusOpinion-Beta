...
const Avatar = ({ src, className, fallbackSize = 20, onClick }) => {
  ...
  if (!src || error) {
    return (/*#__PURE__*/
      ...
      React.createElement(Icon, { icon: "User", size: fallbackSize, className: "text-white/20" })
      ));
...
const CommentItem = ({ comment, onReply }) => {
  ...
  return (/*#__PURE__*/
    React.createElement("div", { className: `flex gap-3 text-sm animate-fade-in ${comment.isPending ? 'opacity-50' : ''} group` }, /*#__PURE__*/
    ...
    React.createElement(Avatar, {
      ...
      onClick: () => {
        ...
        window.location.href = `/profile?id=${comment.user_id}`;
      } }
    )
    )
    ), /*#__PURE__*/
...
const BottomNav = ({ activeTab, setActiveTab, isVisible = true }) => {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement(NavItem, { icon: "User", label: "Profile", isActive: activeTab === 'profile', onClick: () => {} })
    ));
...
const EditProfile = ({ onClose, currentProfile, onSave }) => {
  ...
  return (/*#__PURE__*/
    React.createElement("div", { className: "absolute inset-0 bg-[#020205] z-50 flex flex-col animate-enter overflow-y-auto" }, /*#__PURE__*/

    React.createElement("div", { className: "h-[60px] header-glass sticky top-0 flex items-center justify-between px-4 z-10 shrink-0" }, /*#__PURE__*/
    React.createElement("button", { onClick: onClose, disabled: saving, className: "text-white text-sm font-medium hover:text-white/80" }, "Cancel"), /*#__PURE__*/
    React.createElement("span", { className: "font-heading font-bold text-white" }, "Edit Profile"), /*#__PURE__*/
    React.createElement("button", { onClick: handleSave, disabled: saving, className: "text-neon text-sm font-bold disabled:opacity-50" },
    saving ? 'Saving...' : 'Done'
    )
    ), /*#__PURE__*/

    React.createElement("div", { className: "p-5 space-y-6" }, /*#__PURE__*/

    React.createElement("div", { className: "flex flex-col items-center gap-4 relative" }, /*#__PURE__*/
    React.createElement("div", { className: "relative group cursor-pointer", onClick: () => avatarInputRef.current?.click() }, /*#__PURE__*/
    React.createElement("div", { className: "w-24 h-24 rounded-full border-4 border-white/5 overflow-hidden bg-black" },
    avatarPreview ? /*#__PURE__*/
    React.createElement("img", { src: avatarPreview, className: "w-full h-full object-cover" }) : /*#__PURE__*/

    React.createElement("div", { className: "w-full h-full flex items-center justify-center bg-gray-800" }, /*#__PURE__*/
    React.createElement(Icon, { icon: "User", size: 32, className: "text-neon" })
    )

    ), /*#__PURE__*/
    React.createElement("div", { className: "absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity rounded-full" }, /*#__PURE__*/
    React.createElement(Icon, { icon: "Camera", size: 24, className: "text-white drop-shadow-lg" })
    ),
    ...
    React.createElement("button", {
      ...
      title: "Remove Avatar" }, /*#__PURE__*/

    React.createElement(Icon, { icon: "Trash", size: 12 })
    )
    ...
    React.createElement("button", { onClick: () => avatarInputRef.current?.click(), className: "text-neon text-xs font-bold" }, "Change Profile Photo"

    )
    ), /*#__PURE__*/


    React.createElement("div", { className: "relative h-32 rounded-xl overflow-hidden bg-white/5 border border-white/10 group cursor-pointer", onClick: () => bannerInputRef.current?.click() },
    bannerPreview ? /*#__PURE__*/
    React.createElement("img", { src: bannerPreview, className: "w-full h-full object-cover" }) :
    null, /*#__PURE__*/
    React.createElement("div", { className: "absolute inset-0 bg-gradient-to-br from-black/50 to-black/80 flex items-center justify-center gap-2 group-hover:bg-black/60 transition-colors" }, /*#__PURE__*/
    React.createElement(Icon, { icon: "Camera", size: 20, className: "text-white" }), /*#__PURE__*/
    React.createElement("span", { className: "text-xs font-bold text-white" }, "Edit Banner")
    ),
    ...
    React.createElement("button", {
      ...
      title: "Remove Banner" }, /*#__PURE__*/

    React.createElement(Icon, { icon: "Trash", size: 14 })
    )
    ...
    React.createElement("label", { className: "text-[10px] uppercase font-bold text-muted ml-1" }, "Full Name"), /*#__PURE__*/
    React.createElement("input", { type: "text", value: formData.full_name, onChange: (e) => setFormData({ ...formData, full_name: e.target.value }), className: "w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:border-neon focus:outline-none transition-colors" })
    ), /*#__PURE__*/

    React.createElement("div", { className: "space-y-1" }, /*#__PURE__*/
    React.createElement("label", { className: "text-[10px] uppercase font-bold text-muted ml-1" }, "Bio"), /*#__PURE__*/
    React.createElement("textarea", { value: formData.bio, onChange: (e) => setFormData({ ...formData, bio: e.target.value }), rows: 3, className: "w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:border-neon focus:outline-none transition-colors resize-none" })
    ), /*#__PURE__*/

    React.createElement("div", { className: "space-y-1" }, /*#__PURE__*/
    React.createElement("label", { className: "text-[10px] uppercase font-bold text-muted ml-1" }, "Location"), /*#__PURE__*/
    React.createElement("div", { className: "relative" }, /*#__PURE__*/
    React.createElement("div", { className: "absolute left-4 top-1/2 -translate-y-1/2 text-muted" }, /*#__PURE__*/React.createElement(Icon, { icon: "MapPin", size: 16 })), /*#__PURE__*/
    React.createElement("input", { type: "text", value: formData.location, onChange: (e) => setFormData({ ...formData, location: e.target.value }), className: "w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-white text-sm focus:border-neon focus:outline-none transition-colors" })
    )
    ), /*#__PURE__*/

    React.createElement("div", { className: "space-y-1" }, /*#__PURE__*/
    React.createElement("label", { className: "text-[10px] uppercase font-bold text-muted ml-1" }, "Website"), /*#__PURE__*/
    React.createElement("div", { className: "relative" }, /*#__PURE__*/
    React.createElement("div", { className: "absolute left-4 top-1/2 -translate-y-1/2 text-muted" }, /*#__PURE__*/React.createElement(Icon, { icon: "Link", size: 16 })), /*#__PURE__*/
    React.createElement("input", { type: "text", value: formData.website, onChange: (e) => setFormData({ ...formData, website: e.target.value }), className: "w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-white text-sm focus:border-neon focus:outline-none transition-colors" })
    )
    )
    )
    ));
...
const Post = ({ post, index, onComment, onShare, onSave, comments = [], onAddComment, onImageClick, onRemove, onBookmark, onEdit, onDeleteClick, userProfile, savedPosts }) => {
  ...
  const handleMoreAction = (action) => {
    ...
    if (action === 'edit') {
      ...
      if (onDeleteClick) onDeleteClick(post.id);else
  ...
  if (isHidden) {
    return (/*#__PURE__*/
      ...
      React.createElement("button", { onClick: async () => {
        ...
        }, className: "px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-xs font-medium text-white hover:bg-white/10 transition-colors" }, "Unhide"
  ...
  return (/*#__PURE__*/
    ...
    showShareMenu && /*#__PURE__*/
    React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement("div", { className: "fixed inset-0 z-10", onClick: () => setShowShareMenu(false) }), /*#__PURE__*/
    React.createElement("div", { className: "absolute bottom-14 right-16 z-20 bg-[#0A0F1D] border border-white/10 rounded-xl p-2 shadow-2xl flex flex-col gap-1 w-40 animate-fade-in origin-bottom-right" }, /*#__PURE__*/
    React.createElement("button", { onClick: () => handleShareAction('copy'), className: "flex items-center gap-3 p-2 hover:bg-white/5 rounded-lg text-left text-xs text-white" }, /*#__PURE__*/
    React.createElement(Icon, { icon: "Link", size: 14 }), " Copy Link"
    ), /*#__PURE__*/
    React.createElement("button", { onClick: () => handleShareAction('wa'), className: "flex items-center gap-3 p-2 hover:bg-white/5 rounded-lg text-left text-xs text-white" }, /*#__PURE__*/
    React.createElement(Icon, { icon: "MessageCircle", size: 14 }), " WhatsApp"
    ), /*#__PURE__*/
    React.createElement("button", { onClick: () => handleShareAction('ig'), className: "flex items-center gap-3 p-2 hover:bg-white/5 rounded-lg text-left text-xs text-white" }, /*#__PURE__*/
    React.createElement(Icon, { icon: "Instagram", size: 14 }), " Instagram"
    ), /*#__PURE__*/
    React.createElement("div", { className: "h-px bg-white/10 my-1" }), /*#__PURE__*/
    React.createElement("button", { onClick: () => handleShareAction('more'), className: "flex items-center gap-3 p-2 hover:bg-white/5 rounded-lg text-left text-xs text-white" }, /*#__PURE__*/
    React.createElement(Icon, { icon: "Share", size: 14 }), " More Share"
    )
    )
    ),
    ...
    React.createElement("span", { className: "delayed-label absolute top-12 left-0 bg-black/80 border border-white/10 text-[10px] text-white px-2 py-1 rounded whitespace-nowrap shadow-lg" }, "View Public Profile")
    ), /*#__PURE__*/
    ...
    React.createElement("div", {
      ...
      onClick: () => {vibrate(5);window.location.href = `/profile?id=${post.user_id}`;} }, /*#__PURE__*/

    React.createElement("span", { className: "font-heading font-bold text-white text-sm truncate" }, post.name), /*#__PURE__*/
    React.createElement("span", { className: "delayed-label absolute bottom-6 left-0 bg-black/80 border border-white/10 text-[10px] text-white px-2 py-1 rounded whitespace-nowrap shadow-lg" }, "View Public Profile")
    ), /*#__PURE__*/
    ...
    React.createElement("span", { className: "delayed-label absolute top-5 left-0 bg-black/80 border border-white/10 text-[10px] text-white px-2 py-1 rounded whitespace-nowrap shadow-lg" }, "View Public Profile")
    )
    )
    ), /*#__PURE__*/
    ...
    React.createElement("button", { className: `text-muted hover:text-white transition-colors touch-scale group relative ${showShareMenu ? 'text-white' : ''}`, onClick: () => onShare && onShare(post) }, /*#__PURE__*/
...
const DraftCard = ({ draft, onEdit, onPublish, onDelete }) => /*#__PURE__*/
React.createElement("div", { className: "glass-panel rounded-2xl p-4 mb-4 border-l-2 border-l-neon bg-white/[0.02] relative group" }, /*#__PURE__*/
React.createElement("div", { className: "flex justify-between items-start mb-2" }, /*#__PURE__*/
React.createElement("div", { className: "flex items-center gap-2 text-[10px] font-bold text-neon uppercase tracking-wider" }, /*#__PURE__*/
React.createElement(Icon, { icon: "Lock", size: 12 }), " Private Draft"
), /*#__PURE__*/
React.createElement("div", { className: "flex items-center gap-2" }, /*#__PURE__*/
React.createElement("span", { className: "text-[10px] text-muted" }, draft.time), /*#__PURE__*/
React.createElement("button", { onClick: onDelete, className: "text-muted/50 hover:text-red-500 transition-colors p-1" }, /*#__PURE__*/
React.createElement(Icon, { icon: "X", size: 14 })
)
)
), /*#__PURE__*/
React.createElement("h4", { className: "text-white font-bold text-sm mb-1" }, draft.product, " ", /*#__PURE__*/React.createElement("span", { className: "text-muted font-normal text-xs" }, "\u2022 ", draft.category)), /*#__PURE__*/
React.createElement("p", { className: "text-sm text-gray-400 truncate mb-4" }, draft.text), /*#__PURE__*/
React.createElement("div", { className: "flex gap-2" }, /*#__PURE__*/
React.createElement("button", { onClick: onEdit, className: "flex-1 bg-white/5 hover:bg-white/10 text-white text-xs font-bold py-2 rounded-lg transition-colors" }, "Edit"), /*#__PURE__*/
React.createElement("button", { onClick: onPublish, className: "flex-1 bg-neon/10 hover:bg-neon/20 text-neon text-xs font-bold py-2 rounded-lg transition-colors" }, "Publish")
)
);
...
const ShareModal = ({ isOpen, onClose, post, user }) => {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("span", { className: "text-white font-heading font-bold text-lg" }, isProfile ? 'Share Profile' : 'Share Interaction'), /*#__PURE__*/
...
const ReportModal = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement(Icon, { icon: "ArrowLeft", size: 16, className: "rotate-180 text-white/20 group-hover:text-white transition-colors" })
    )
    )
    )
    ),
...
const SettingsModal = ({ isOpen, onClose }) => {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("div", { className: "flex justify-between items-center mb-6 shrink-0" }, /*#__PURE__*/
    React.createElement("span", { className: "text-white font-heading font-bold text-lg flex items-center gap-2" },
    currentView === 'blocked' && /*#__PURE__*/
    React.createElement("button", { onClick: () => setCurrentView('main'), className: "p-1 -ml-1 text-white/60 hover:text-white transition-colors" }, /*#__PURE__*/
    ...
    currentView === 'main' ? /*#__PURE__*/
    React.createElement("div", { className: "space-y-4" }, /*#__PURE__*/
    React.createElement("div", { className: "p-4 rounded-2xl bg-white/[0.03] border border-white/5" }, /*#__PURE__*/
    React.createElement("h3", { className: "text-xs font-bold text-neon uppercase tracking-widest mb-4" }, "Account Privacy"), /*#__PURE__*/
    React.createElement("div", { className: "space-y-4" }, /*#__PURE__*/
    React.createElement("div", { className: "flex items-center justify-between opacity-50" }, /*#__PURE__*/
    React.createElement("div", { className: "flex items-center gap-3" }, /*#__PURE__*/
    React.createElement("div", { className: "p-2 rounded-lg bg-blue-500/10 text-blue-400 font-bold" }, /*#__PURE__*/React.createElement(Icon, { icon: "Lock", size: 18 })), /*#__PURE__*/
    React.createElement("div", null, /*#__PURE__*/
    React.createElement("div", { className: "text-sm font-bold text-white" }, "Private Profile"), /*#__PURE__*/
    React.createElement("div", { className: "text-[10px] text-muted" }, "Only followers can see your posts")
    )
    ), /*#__PURE__*/
    React.createElement("div", { className: "w-10 h-5 bg-white/10 rounded-full relative cursor-not-allowed" }, /*#__PURE__*/
    React.createElement("div", { className: "absolute left-1 top-1 w-3 h-3 bg-white/30 rounded-full" })
    )
    ), /*#__PURE__*/
    React.createElement("div", { className: "text-[10px] text-neon/40 font-bold uppercase tracking-wider text-right" }, "Available in Beta 2.0")
    )
    ), /*#__PURE__*/

    React.createElement("div", { className: "p-4 rounded-2xl bg-white/[0.03] border border-white/5" }, /*#__PURE__*/
    React.createElement("h3", { className: "text-xs font-bold text-neon uppercase tracking-widest mb-4" }, "Interactions"), /*#__PURE__*/
    React.createElement("button", {
      onClick: () => setCurrentView('blocked'),
      className: "w-full flex items-center justify-between hover:bg-white/5 p-2 -mx-2 rounded-lg transition-colors group" }, /*#__PURE__*/

    React.createElement("div", { className: "flex items-center gap-3" }, /*#__PURE__*/
    React.createElement("div", { className: "p-2 rounded-lg bg-red-500/10 text-red-400 font-bold" }, /*#__PURE__*/React.createElement(Icon, { icon: "EyeOff", size: 18 })), /*#__PURE__*/
    React.createElement("div", { className: "text-left" }, /*#__PURE__*/
    React.createElement("div", { className: "text-sm font-bold text-white" }, "Blocked Users"), /*#__PURE__*/
    React.createElement("div", { className: "text-[10px] text-muted" }, "Manage accounts you've blocked")
    )
    ), /*#__PURE__*/
    React.createElement(Icon, { icon: "ArrowLeft", size: 16, className: "rotate-180 text-white/20 group-hover:text-white" })
    )
    ), /*#__PURE__*/

    React.createElement("div", { className: "p-4 rounded-2xl bg-white/[0.03] border border-white/5" }, /*#__PURE__*/
    React.createElement("h3", { className: "text-xs font-bold text-neon uppercase tracking-widest mb-4" }, "Preferences"), /*#__PURE__*/
    React.createElement("div", { className: "space-y-4" }, /*#__PURE__*/
    React.createElement("div", { className: "flex items-center justify-between opacity-50" }, /*#__PURE__*/
    React.createElement("div", { className: "flex items-center gap-3" }, /*#__PURE__*/
    React.createElement("div", { className: "p-2 rounded-lg bg-orange-500/10 text-orange-400 font-bold" }, /*#__PURE__*/React.createElement(Icon, { icon: "Bell", size: 18 })), /*#__PURE__*/
    React.createElement("div", null, /*#__PURE__*/
    React.createElement("div", { className: "text-sm font-bold text-white" }, "Push Notifications"), /*#__PURE__*/
    React.createElement("div", { className: "text-[10px] text-muted" }, "Manage all alerts")
    )
    ), /*#__PURE__*/
    React.createElement("div", { className: "w-10 h-5 bg-white/10 rounded-full relative cursor-not-allowed" }, /*#__PURE__*/
    React.createElement("div", { className: "absolute left-1 top-1 w-3 h-3 bg-white/30 rounded-full" })
    ...
    React.createElement("div", { className: "bg-white/5 rounded-xl p-4 text-center" }, /*#__PURE__*/
    React.createElement("div", { className: "text-[10px] text-white/40 leading-relaxed" }, "Version 1.15.2 (Beta)", /*#__PURE__*/
    React.createElement("br", null), "PlusOpinion Premium Features coming soon."
    ...
    React.createElement("div", { className: "space-y-2" },
    loadingBlocks ? /*#__PURE__*/
    React.createElement("div", { className: "flex flex-col items-center justify-center py-10 gap-3" }, /*#__PURE__*/
    React.createElement("div", { className: "w-8 h-8 rounded-full border-2 border-neon/20 border-t-neon animate-spin" }), /*#__PURE__*/
    React.createElement("span", { className: "text-xs text-muted" }, "Loading...")
    ) :
    blockedUsers.length === 0 ? /*#__PURE__*/
    React.createElement("div", { className: "flex flex-col items-center justify-center py-10 opacity-40" }, /*#__PURE__*/
    React.createElement(Icon, { icon: "Slash", size: 48, className: "mb-3" }), /*#__PURE__*/
    React.createElement("span", { className: "text-sm" }, "No blocked users")
    ) :

    blockedUsers.map((u) => /*#__PURE__*/
    React.createElement("div", { key: u.id, className: "flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5" }, /*#__PURE__*/
    React.createElement("div", { className: "flex items-center gap-3" }, /*#__PURE__*/
    React.createElement("img", { src: u.avatar_url || DEFAULT_AVATAR, className: "w-10 h-10 rounded-full object-cover border border-white/10" }), /*#__PURE__*/
    React.createElement("div", null, /*#__PURE__*/
    React.createElement("div", { className: "text-sm font-bold text-white" }, u.full_name), /*#__PURE__*/
    React.createElement("div", { className: "text-xs text-muted" }, "@", u.username)
    )
    ), /*#__PURE__*/
    React.createElement("button", {
...
React.createElement("div", { className: "animate-fade-in flex-1 flex flex-col relative h-full" }, /*#__PURE__*/
...
React.createElement("div", { className: "w-full h-10 rounded-full bg-[#1c1e1e] animate-pulse mb-6" }), /*#__PURE__*/
...
const DeleteModal = ({ isOpen, onClose, onConfirm, title, message }) => {
  if (!isOpen) return null;
  return (/*#__PURE__*/
    React.createElement("div", { className: "fixed inset-0 z-[120] flex items-center justify-center px-4" }, /*#__PURE__*/
    React.createElement("div", { className: "absolute inset-0 bg-black/60 backdrop-blur-sm animate-fade-in", onClick: onClose }), /*#__PURE__*/
    React.createElement("div", { className: "relative bg-[#1A1C2E] border border-white/10 p-6 rounded-2xl shadow-2xl w-full max-w-sm animate-scale-up" }, /*#__PURE__*/
    React.createElement("h3", { className: "text-xl font-bold text-white mb-2" }, title), /*#__PURE__*/
    React.createElement("p", { className: "text-gray-400 mb-6" }, message), /*#__PURE__*/
    React.createElement("div", { className: "flex gap-3" }, /*#__PURE__*/
    React.createElement("button", { onClick: onClose, className: "flex-1 py-3 rounded-xl bg-white/5 hover:bg-white/10 text-white font-medium transition-colors" }, "Cancel"), /*#__PURE__*/
    React.createElement("button", { onClick: onConfirm, className: "flex-1 py-3 rounded-xl bg-red-500 hover:bg-red-600 text-white font-bold transition-colors shadow-lg shadow-red-500/20" }, "Delete")
    )
    )
    ));
...
const App = () => {
  ...
  if (profileLoading) {
    return (/*#__PURE__*/
      ...
      React.createElement("div", { className: "h-[60px] header-glass flex items-center justify-between px-4 sticky top-0 z-30 shrink-0" }, /*#__PURE__*/
      React.createElement("button", { className: "p-2 rounded-full hover:bg-white/5 relative z-10", onClick: () => window.history.back() }, /*#__PURE__*/React.createElement(Icon, { icon: "ArrowLeft", size: 20 }))
      ), /*#__PURE__*/
      React.createElement(SkeletonProfile, null), /*#__PURE__*/
      React.createElement(ShareModal, { isOpen: isShareModalOpen, onClose: () => setIsShareModalOpen(false), post: sharePostData }), /*#__PURE__*/
      React.createElement(BottomNav, { activeTab: activeTab, setActiveTab: setActiveTab, isVisible: true })
      ));
  ...
  return (/*#__PURE__*/
    React.createElement("div", { className: "flex-1 flex flex-col relative h-full overflow-hidden" }, /*#__PURE__*/
    React.createElement(ImageViewer, { src: selectedImage?.src, type: selectedImage?.type, images: selectedImage?.images, initialIndex: selectedImage?.initialIndex || 0, onClose: () => setSelectedImage(null) }),


    view === 'edit' && /*#__PURE__*/React.createElement(EditProfile, { onClose: () => setView('profile'), currentProfile: profileData, onSave: loadUserProfile }), /*#__PURE__*/
    ...
    React.createElement(SettingsModal, { isOpen: isSettingsModalOpen, onClose: () => setIsSettingsModalOpen(false) }), /*#__PURE__*/
    ...
    React.createElement("div", { className: "flex items-center gap-2 relative z-10" }, /*#__PURE__*/
    ...
    menuOpen && /*#__PURE__*/
    React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement("div", { className: "fixed inset-0 z-30", onClick: () => setMenuOpen(false) }), /*#__PURE__*/
    React.createElement("div", { className: "absolute top-10 right-0 w-40 bg-[#1A1C2E] border border-white/10 rounded-xl shadow-2xl z-40 overflow-hidden animate-enter" }, /*#__PURE__*/
    React.createElement("button", { className: "w-full text-left px-4 py-3 text-sm text-white hover:bg-white/5 flex items-center gap-2",
      onClick: () => {
        setMenuOpen(false);
        vibrate();
    ...
    React.createElement("button", { className: "w-full text-left px-4 py-3 text-sm text-white hover:bg-white/5 flex items-center gap-2 border-t border-white/5",
      onClick: () => {
        setMenuOpen(false);
        vibrate();
        setIsSettingsModalOpen(true);
      } }, /*#__PURE__*/
    React.createElement(Icon, { icon: "Settings", size: 16 }), " Settings"
    )
    )
    )
    ...
    profileData.banner_url ? /*#__PURE__*/
    React.createElement("div", { className: "h-[140px] w-full relative overflow-hidden" }, /*#__PURE__*/
    React.createElement("img", { src: profileData.banner_url, alt: "Banner", className: "w-full h-full object-cover" })
    ) : /*#__PURE__*/
    ...
    React.createElement("div", { className: "profile-avatar-container bg-[#020205]" },
    profileData.avatar_url && !imgError ? /*#__PURE__*/
    React.createElement("img", {
    ...
    React.createElement("img", { src: DEFAULT_AVATAR, className: "w-full h-full object-cover" })

    )
    ), /*#__PURE__*/


    React.createElement("div", { className: "absolute bottom-3 right-4 flex gap-2" }, /*#__PURE__*/
    React.createElement("button", { onClick: () => {vibrate();setView('edit');}, className: "bg-black/40 backdrop-blur-md border border-white/10 text-white text-xs font-bold px-4 py-2 rounded-xl hover:bg-white/10 active:scale-95 transition-all" }, "Edit Profile"
    ...
    React.createElement("div", { className: "px-5 mt-2 mb-8" }, /*#__PURE__*/
    React.createElement("div", { className: "flex items-start justify-between gap-4 mb-1" }, /*#__PURE__*/
    React.createElement("div", { className: "flex-1 min-w-0" }, /*#__PURE__*/
    React.createElement("h1", { className: "text-2xl font-heading font-bold text-white leading-tight truncate" }, profileData.full_name), /*#__PURE__*/
    React.createElement("div", { className: "flex items-center gap-2 text-sm text-white/60 flex-wrap mt-1" }, /*#__PURE__*/
    React.createElement("span", null, "@", profileData.username),
    profileData.location && /*#__PURE__*/
    React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement("span", { className: "text-white/40" }, "\u2022"), /*#__PURE__*/
    React.createElement("span", { className: "flex items-center gap-1" }, /*#__PURE__*/React.createElement(Icon, { icon: "MapPin", size: 12 }), " ", profileData.location)
    )
    ...
    React.createElement("button", {
      ...
      title: `Inbox (EST #${userBadge})` }, /*#__PURE__*/
    ...
    profileData.bio && /*#__PURE__*/
    React.createElement("p", { className: "text-sm text-gray-300 font-light leading-relaxed" }, profileData.bio),

    !profileData.bio && /*#__PURE__*/
    React.createElement("p", { className: "text-sm text-gray-500 font-light italic" }, "This user prefers to keep their bio a mystery.")

    ),

    profileData.website && /*#__PURE__*/
    React.createElement("div", { className: "flex items-center gap-2 text-sm text-neon mb-6" }, /*#__PURE__*/
    React.createElement(Icon, { icon: "Link", size: 14 }), /*#__PURE__*/
    React.createElement("a", { href: "#", className: "hover:underline" }, profileData.website)
    ),
    " ", /*#__PURE__*/
    ...
    React.createElement("span", { className: "text-white font-heading font-bold leading-none" }, profileData.rqs)
    )
    )
    ), /*#__PURE__*/
    ...
    React.createElement("span", { className: "text-white font-bold text-sm tracking-wide" }, profileData.verified_count || 0), /*#__PURE__*/
    ...
    React.createElement("div", { className: `sticky z-20 bg-[#020205] border-b border-white/5 mb-4 shadow-lg transition-[top] duration-300 ease-out`, style: { top: navVisible ? '60px' : '0px' } }, /*#__PURE__*/
    React.createElement("div", { className: "flex overflow-x-auto no-scrollbar px-4" },
    ...
    tab === 'seen' && /*#__PURE__*/React.createElement("span", { className: "flex items-center gap-1" }, "Seen ", /*#__PURE__*/React.createElement(Icon, { icon: "Zap", size: 12, className: contentTab === tab ? "text-neon" : "" })),
    tab === 'drafts' && /*#__PURE__*/React.createElement("span", { className: "flex items-center gap-1" }, "Drafts ", /*#__PURE__*/React.createElement(Icon, { icon: "Lock", size: 12 }))
    ),
    ...
    contentLoading && /*#__PURE__*/
    React.createElement("div", { className: "text-center py-20 text-muted" }, /*#__PURE__*/
    React.createElement("div", { className: "animate-spin w-6 h-6 border-2 border-neon border-t-transparent rounded-full mx-auto mb-2" }), "Loading..."

    ),


    !contentLoading && contentTab === 'opinions' && /*#__PURE__*/
    React.createElement("div", { className: "animate-enter" },
    posts.length === 0 ? /*#__PURE__*/
    React.createElement("div", { className: "text-center py-20 text-muted/40 tracking-widest font-heading" }, "NO OPINIONS YET"

    ) :

    posts.map((post) => /*#__PURE__*/
    ...
    !contentLoading && contentTab === 'comments' && /*#__PURE__*/
    React.createElement("div", { className: "animate-enter" },
    commentedPosts.length === 0 ? /*#__PURE__*/
    React.createElement("div", { className: "text-center py-20 text-muted/40 tracking-widest font-heading" }, "NO COMMENTS YET"

    ) :

    commentedPosts.map((post) => /*#__PURE__*/
    React.createElement(Post, {
      key: post.id,
      post: post,
      userProfile: profileData,
    ...
    !contentLoading && contentTab === 'drafts' && /*#__PURE__*/
    React.createElement("div", { className: "animate-enter" }, /*#__PURE__*/
    React.createElement("div", { className: "mb-4 flex items-center gap-2 p-3 rounded-xl bg-neon/5 border border-neon/10" }, /*#__PURE__*/
    React.createElement(Icon, { icon: "Lock", size: 16, className: "text-neon" }), /*#__PURE__*/
    React.createElement("p", { className: "text-xs text-neon/80" }, "These are private drafts visible only to you.")
    ),
    drafts.length === 0 ? /*#__PURE__*/
    React.createElement("div", { className: "text-center text-xs text-muted/40 py-10" }, "No drafts yet"

    ) :

    drafts.map((draft) => /*#__PURE__*/
    ...
    !contentLoading && contentTab === 'seen' && /*#__PURE__*/
    ...
    React.createElement("span", { className: "text-xs font-heading tracking-widest" }, "Coming Soon")
    )
    ...
    React.createElement("button", {
      ...
      className: `absolute bottom-24 right-5 bg-neon text-white h-12 pl-4 pr-5 rounded-full flex items-center gap-2 z-30 transition-all duration-500 opinion-btn ${fabVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}` }, /*#__PURE__*/
